...
function volunteer_civicrm_enable() {
  ...
  CRM_Core_Session::setStatus(
    ...
    ts('<p>Thank you for installing the beta version of CiviVolunteer! Documentation is still a work in progress.</p><p>To get started, visit <a href="%1">Manage Events</a> and enable volunteer management from the new Volunteer tab on one of your events.</p>'),
