...
class CRM_Volunteer_DAO_Need extends CRM_Core_DAO
{
  ...
  public $start_time;
  /**
   * if times are flexible then duration is probably more appropriate than an end_time field
   *
   * @var float
   */
  public $duration;
  /**
   * boolean indicating whether or not the time is flexible
   *
   * @var boolean
   */
  public $is_flexible;
  ...
  public $quantity;
  /**
   * Initially, this will be just a label (e.g., Lifeguard), but in future releases roles will have additional properties, such as qualifications.
   *
   * @var string
   */
  public $role_id;
  /**
   * Artificial FK to other CiviCRM entity.
   *
   * @var int unsigned
   */
  public $entity_id;
    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        ...
        'role_id' => array(
          ...
          'title' => ts('Role associated with this Need') ,
          'maxlength' => 128,
